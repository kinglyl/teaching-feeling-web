    ...
    $.setStorage = function(key,val){
        ...
        try {
            if (typeof require != "undefined") {
                ...
                console.log('$.setStorage() failed due to environment issues.');
            }
        } catch (e) {
	...
	$.getStorage = function(key){
		...
		try{
            ...
            if (typeof require != "undefined") {    		
                ...
                console.log('$.getStorage() failed due to environment issues.');
                return null;
            }
		  ...
		  console.log("この環境はセーブ機能を利用できません。ローカルで実行している場合などに発生します");
          return null;
		}
