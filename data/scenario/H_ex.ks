...
[cum_out]
#
（在到達極限的瞬間我把陰莖抽了出來把精液華麗的揮灑到了希爾薇的身上）[p]
[if  exp="f.h_in>=3" ]
...
[endif]
#
（射精的同時希爾薇也達到了絕頂。兩人同時噴出的體液被彈向了空中）[p]
[left_non]
[right_non]
[cum_add]
[v_show]
...
[eval  exp="f.y_ex=f.y_ex+1" ]
#
（希爾薇因為絕頂讓肉棒獲得了更深層次的刺激。這讓我也無法忍受）[p]
...
[cum_out]
#
（在到達極限的瞬間我把陰莖抽了出來，把精液華麗的揮灑到了希爾薇的身上）[p]
[if  exp="f.h_in>=3" ]
[chara_mod  name="z-b"  time="0"  storage="chara/26/z3.png" ]
[elsif  exp="f.h_in==2" ]
[chara_mod  name="z-b"  time="0"  storage="chara/26/z2.png" ]
...
[eval  exp="f.h_act='off'" ]
#
（還因精液的余力而抽搐的希爾薇身體上沾滿的我的精華在閃閃發亮）[p]
#希爾薇
[if exp="f.s_ex==1" ]
...
[cm]
[if  exp="f.y_ex>=1" ]
射精[emb exp="f.y_ex" ]次[r]
[endif]
[if  exp="f.s_ex>=1" ]
希爾薇絶頂[emb exp="f.s_ex" ]次[p]
[endif]
