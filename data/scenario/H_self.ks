[_tb_system_call storage=system/_H_self.ks]
...
#
（希爾薇躺在床上，用手指輕輕的撫摸自己私處的一部分）[p]
（壹時間用在意的視線監視著我這邊[r]
像是死心了那樣慢慢地開始動手指）[p]

[bg  time="1"  method="crossfade"  storage="auto1-1.jpg" ]
[chara_mod  name="se"  time="0"  storage="chara/se/auto1-1,2.png" ]
[chara_mod  name="tx"  time="0"  storage="chara/text/auto1-1,2.png" ]
[chara_mod  name="ef"  time="0"  storage="chara/effect/auto1-1,2.png" ]
...
#
（剛開始像是當初看見希爾微自慰的時候壹樣[r]
她用左邊剩下的袖子壹邊按住口鼻壹邊用右手動作）[p]
...
[bg  time="1"  method="crossfade"  storage="auto1-2.jpg" ]
[playse  loop="true"  storage="l-wet0.ogg"  clear="true"  ]
#
（從床上開始聽到她的呼吸以外的聲音）[p]

（用保守的動作玩弄著秘部的希爾薇的指尖開始濕潤[r]
...
[bg  time="1"  method="crossfade"  storage="auto1-3.jpg" ]
[chara_mod  name="se"  time="0"  storage="chara/se/auto1-3-6.png" ]
[chara_mod  name="tx"  time="0"  storage="chara/text/auto1-3,4.png" ]
[chara_mod  name="ef"  time="0"  storage="chara/effect/auto1-3,4.png" ]


（本人秘部迴響的下流的聲音被聽見的想到了嗎？[r]
看了看樣子的情况）[p]

[bg  time="1"  method="crossfade"  storage="auto1-4.jpg" ]

（視線碰到的話，希爾薇的表情也染上了羞耻[r]
馬上就把眼睛閉上了）[p]
...
[bg  time="1"  method="crossfade"  storage="auto1-5.jpg" ]
[chara_mod  name="tx"  time="0"  storage="chara/text/auto1-5,6.png" ]
[chara_mod  name="ef"  time="0"  storage="chara/effect/auto1-5,6.png" ]
#希爾薇
哇啊…♡…呼喔…♡♡[p]
...
#
（希爾薇起來叫我之後不再繼續說有意義的話[lr]
或許那種表達方式是她「行為」的壹個部分[p]

#希爾薇
嗯♡…[name]♡♡…[name]♡[p]

[bg  time="1"  method="crossfade"  storage="auto1-6.jpg" ]
...
#
（希爾薇透露出的呼吸和秘部迴響的水的聲音變得很大地激烈起來）[p]
...
[bg  time="1"  method="crossfade"  storage="auto1-7.jpg" ]
[chara_mod  name="se"  time="0"  storage="chara/se/auto1-7.png" ]
[chara_mod  name="tx"  time="0"  storage="chara/text/auto1-7.png" ]
[chara_mod  name="ef"  time="0"  storage="chara/effect/auto1-7.png" ]
#希爾薇
嗯！♡…呼喔…♡♡嗯…♡♡♡！[p]

#
（希爾薇緊緊地著僵身體，絕頂快感讓身體板起了）[p]

[bg  time="1"  method="crossfade"  storage="auto1-8.jpg" ]
[chara_mod  name="se"  time="0"  storage="chara/se/auto1-8.png" ]
[chara_mod  name="tx"  time="0"  storage="chara/text/auto1-8.png" ]
[chara_mod  name="ef"  time="0"  storage="chara/effect/auto1-8.png" ]
#希爾薇
哈…哈……嗯…喔…♡[p]
……
...
[cancelskip]
[jump  storage="H_before.ks"  target="*self_after" ]
