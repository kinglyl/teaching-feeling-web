...
[button  storage=""  target="*medi_z"  graphic="ch/medi-y.png"    x="0"  y="180" hint="コマンドえっちで射精上限がなくなります" ]
[button  storage=""  target="*medi_x"  graphic="ch/medi-s.png"   x="0"  y="300" hint="コマンドえっちでシルヴィの絶頂上限がなくなります" ]
